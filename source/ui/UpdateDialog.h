...
public:
  UpdateDialog(const crtloss::network::UpdateInfo& info,
  ...
  static UpdateDialog* ShowInComponent(const crtloss::network::UpdateInfo& info,
                                       std::function<void()> onClose = {});
...
private:
  ...
  crtloss::network::UpdateInfo info_;
